...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .summary h1 { margin: 0; font-family: "Sora", sans-serif; font-size: clamp(1.3rem,2.5vw,1.9rem); }
                    ...
                    <article class="voucher-card">
                        ...
                        <div class="value">
                            <c:choose>
                                ...
                                <c:otherwise><fmt:formatNumber value="${v.discountValue}" type="number" groupingUsed="true" /> OFF</c:otherwise>
                            </c:choose>
                        </div>
                        <div class="meta">Target group: ${v.targetGroup}</div>
                        <div class="meta">Usage: ${v.usedCount}/${v.usageLimit}</div>
                        <div class="meta">Expires: <fmt:formatDate value="${v.expiryDate}" pattern="dd/MM/yyyy HH:mm" /></div>
                    </article>
                </c:forEach>
            </section>
        </c:otherwise>
