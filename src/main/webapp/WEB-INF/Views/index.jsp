    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            <main class="page">
                ...
                <section class="hero">
                    <img src="https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?auto=format&fit=crop&w=1600&q=80"
                        alt="Hotel exterior">
                ...
                <form class="search-card" method="GET" action="${pageContext.request.contextPath}/home">
                    <div class="field">
                        <input type="hidden" name="action" value="search-free-rooms">
                        <label>Check-in Date</label>
                        <input type="date" name="checkInSearch" value="${checkInSearch}" required>
                    </div>
                    <div class="field">
                        <label>Check-out Date</label>
                        <input type="date" name="checkOutSearch" value="${checkOutSearch}" required>
                    </div>
                    <div class="field">
                        <label>Room Type</label>
                        <select name="roomTypeFilter">
                    ...
                    <div style="display:flex; gap:10px; align-items:end; height: 100%;">
                        <button class="search-btn" type="submit" style="flex:1;">Search</button>
                        <c:if test="${not empty checkInSearch}">
                            <a href="${pageContext.request.contextPath}/home?action=clear-search" class="search-btn" style="flex:1; background: #64748b; text-align:center; text-decoration:none; display:flex; align-items:center; justify-content:center;">Clear</a>
                        </c:if>
                    </div>
                </form>
                        ...
                        <c:forEach var="room" items="${allRooms}" begin="0" end="3">
                            <article class="room-card">
                                ...
                                <div class="content">
                                    ...
                                    <p>${room.roomType.basePrice} VND/night</p>
                                    <a href="${pageContext.request.contextPath}/room?action=detail&id=${room.id}">View/Book
                                        Now</a>
                                </div>
                            </article>
                        </c:forEach>
            ...
            <script>
                ...
                const allRooms = [
                    <c:forEach var="room" items="${allRooms}" varStatus="loop">
                        ...
                        price: '${room.roomType.basePrice} VND/night',
