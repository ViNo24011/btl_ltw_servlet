            ...
            <nav class="navbar navbar-light bg-light border-bottom">
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a class="btn btn-custom me-2" href="${pageContext.request.contextPath}/admin/room?action=new">
                            Add Room
                        </a>
                        <a class="btn btn-roomtype me-2" href="${pageContext.request.contextPath}/home">
                            Quay lại
                        </a>
