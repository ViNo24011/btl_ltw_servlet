...
<body>
    ...
    <div class="form-container w-100">
        ...
        <p class="text-success">${param.message == 'success' ? 'Registration successful! Please login.' : ''}</p>
        ...
        <form action="login" method="post">
            ...
            <div class="d-flex align-items-center">
                <button type="submit" class="btn btn-custom me-3">Login</button>
                <span>Don't have an account? <a href="register" style="color: blue; text-decoration: underline;">Register</a></span>
            </div>
        </form>
    </div>
</div>
